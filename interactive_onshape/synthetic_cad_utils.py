...
def get_sketch(plane_dict, sketch, feat_id=-1, face_mesh=[], body_type="NEW"):
    sketch_lines_dict = {}
...
def synthetize_new_object_opensketch(sequence_length, sequence=[], data_folder=None):
    ...
    #exit()
    template_url = "https://cad.onshape.com/documents/ca678cd1cbb893f212f3eeb6/w/d0e5a0318bbd2ebf61c5498f/e/f1056197d09af4ef4cf9baed"
    ...
    plane_dict = get_plane(client, feat_id, new_url, bd, orientation= "HORIZONTAL")
    sketch_dict, sketch_radius = get_sketch(plane_dict, sketch, feat_id=feat_id)
    ...
    extrude_dict = get_extrude_dict(sketch_feat_id, depth=last_extrude_depth, body_type="NEW")
    client.add_feature(docid, wid, eid, payload=extrude_dict)
